...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-open-in-app': { kind: 'none', reason: 'Browser-side Session-menu item opening the workspace directory for a human; registers nothing model-facing.' },
