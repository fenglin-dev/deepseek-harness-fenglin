...
const en = {
  app: 'DeepSeek Harness Fenglin', file: 'File', edit: 'Edit', view: 'View', tools: 'Tools', window: 'Window', help: 'Help', more: 'More',
  about: 'About DeepSeek Harness Fenglin', settings: 'Settings…', updates: 'Check for Updates…',
  ...
  cancel: 'Cancel', community: 'Maintained by fenglin-dev. Personal customized version, not an official DeepSeek product.',
}
const zh: typeof en = {
  app: 'DeepSeek Harness Fenglin', file: '文件', edit: '编辑', view: '视图', tools: '工具', window: '窗口', help: '帮助', more: '更多',
  about: '关于 DeepSeek Harness Fenglin', settings: '设置…', updates: '检查更新…', 'new-session': '新对话',
  ...
  community: '由 fenglin-dev 维护的个人定制版，并非 DeepSeek 官方产品。',
}
