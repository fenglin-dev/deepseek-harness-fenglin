...
const zh = {
  ...
  pluginsLabel: '已有插件', buildsLabel: '构建权限', compare: '查看完整对比', returnMain: '回到主页面', back: '上一步',
...
const en: typeof zh = {
  ...
  pluginsLabel: 'Existing plugins', buildsLabel: 'Build approvals', compare: 'View full comparison', returnMain: 'Back to main page', back: 'Back',
