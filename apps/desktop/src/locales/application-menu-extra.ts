...
const ja: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: 'ファイル', edit: '編集', view: '表示', tools: 'ツール', window: 'ウインドウ', help: 'ヘルプ', more: 'その他',
  about: 'Open DSH Desktop について', settings: '設定…', updates: 'アップデートを確認…', 'new-session': '新しい会話',
  ...
  reload: '再読み込み', market: 'プラグインマーケット', 'plugin-restore': 'プラグインの復元', diagnostics: '診断センター', snapshots: 'プラグインスナップショット',
  ...
  hide: 'Open DSH Desktop を隠す', 'hide-others': 'ほかを隠す', unhide: 'すべてを表示', emoji: '絵文字と記号', error: '操作を完了できません',
...
const ko: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: '파일', edit: '편집', view: '보기', tools: '도구', window: '창', help: '도움말', more: '더 보기',
  about: 'Open DSH Desktop 정보', settings: '설정…', updates: '업데이트 확인…', 'new-session': '새 대화',
  ...
  fullscreen: '전체 화면 시작', 'leave-fullscreen': '전체 화면 종료', reload: '새로 고침', market: '플러그인 마켓', 'plugin-restore': '플러그인 복구', diagnostics: '진단 센터',
  ...
  logs: '로그 디렉터리 열기', devtools: '개발자 도구', services: '서비스', hide: 'Open DSH Desktop 숨기기', 'hide-others': '다른 항목 숨기기',
...
const es: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: 'Archivo', edit: 'Edición', view: 'Ver', tools: 'Herramientas', window: 'Ventana', help: 'Ayuda', more: 'Más',
  about: 'Acerca de Open DSH Desktop', settings: 'Ajustes…', updates: 'Buscar actualizaciones…', 'new-session': 'Nueva conversación',
  ...
  reload: 'Recargar', market: 'Mercado de plugins', 'plugin-restore': 'Recuperación de plugins', diagnostics: 'Centro de diagnóstico', snapshots: 'Instantáneas de plugins',
  ...
  hide: 'Ocultar Open DSH Desktop', 'hide-others': 'Ocultar las demás', unhide: 'Mostrar todo', emoji: 'Emojis y símbolos', error: 'No se pudo completar la acción',
...
const fr: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: 'Fichier', edit: 'Édition', view: 'Présentation', tools: 'Outils', window: 'Fenêtre', help: 'Aide', more: 'Plus',
  about: 'À propos d’Open DSH Desktop', settings: 'Réglages…', updates: 'Rechercher les mises à jour…', 'new-session': 'Nouvelle conversation',
  ...
  reload: 'Recharger', market: 'Marché des plugins', 'plugin-restore': 'Récupération des plugins', diagnostics: 'Centre de diagnostic', snapshots: 'Instantanés des plugins',
  ...
  hide: 'Masquer Open DSH Desktop', 'hide-others': 'Masquer les autres', unhide: 'Tout afficher', emoji: 'Emoji et symboles', error: 'Impossible d’effectuer l’action',
...
const de: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: 'Datei', edit: 'Bearbeiten', view: 'Ansicht', tools: 'Werkzeuge', window: 'Fenster', help: 'Hilfe', more: 'Mehr',
  about: 'Über Open DSH Desktop', settings: 'Einstellungen…', updates: 'Nach Updates suchen…', 'new-session': 'Neue Unterhaltung',
  ...
  reload: 'Neu laden', market: 'Plugin-Markt', 'plugin-restore': 'Plugin-Wiederherstellung', diagnostics: 'Diagnosezentrum', snapshots: 'Plugin-Snapshots',
  ...
  hide: 'Open DSH Desktop ausblenden', 'hide-others': 'Andere ausblenden', unhide: 'Alle einblenden', emoji: 'Emoji und Symbole', error: 'Aktion konnte nicht abgeschlossen werden',
...
const ptBR: ApplicationMenuCopy = {
  app: 'Open DSH Desktop', file: 'Arquivo', edit: 'Editar', view: 'Visualizar', tools: 'Ferramentas', window: 'Janela', help: 'Ajuda', more: 'Mais',
  about: 'Sobre o Open DSH Desktop', settings: 'Configurações…', updates: 'Verificar atualizações…', 'new-session': 'Nova conversa',
  ...
  reload: 'Recarregar', market: 'Mercado de plugins', 'plugin-restore': 'Recuperação de plugins', diagnostics: 'Central de diagnóstico', snapshots: 'Snapshots de plugins',
  ...
  hide: 'Ocultar Open DSH Desktop', 'hide-others': 'Ocultar outros', unhide: 'Mostrar tudo', emoji: 'Emoji e símbolos', error: 'Não foi possível concluir a ação',
