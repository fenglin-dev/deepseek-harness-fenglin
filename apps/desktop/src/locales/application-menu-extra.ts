...
const ja: ApplicationMenuCopy = {
  ...
  'external-tools': 'ツールと機能', phone: 'スマートフォンからのアクセス', im: 'IM ボット', 'data-home': '設定ディレクトリを切り替える…', restart: 'クイック再起動',
...
const ko: ApplicationMenuCopy = {
  ...
  snapshots: '플러그인 스냅샷', 'external-tools': '도구 및 기능', phone: '휴대전화 접속', im: 'IM 봇', 'data-home': '구성 디렉터리 전환…', restart: '빠른 재시작',
...
const es: ApplicationMenuCopy = {
  ...
  'external-tools': 'Herramientas y capacidades', phone: 'Acceso móvil', im: 'Bots de IM', 'data-home': 'Cambiar directorio de configuración…', restart: 'Reinicio rápido',
...
const fr: ApplicationMenuCopy = {
  ...
  'external-tools': 'Outils et fonctionnalités', phone: 'Accès mobile', im: 'Robots IM', 'data-home': 'Changer de dossier de configuration…', restart: 'Redémarrage rapide',
...
const de: ApplicationMenuCopy = {
  ...
  'external-tools': 'Werkzeuge und Funktionen', phone: 'Mobilzugriff', im: 'IM-Bots', 'data-home': 'Konfigurationsverzeichnis wechseln…', restart: 'Schnell neu starten',
...
const ptBR: ApplicationMenuCopy = {
  ...
  'external-tools': 'Ferramentas e recursos', phone: 'Acesso pelo celular', im: 'Bots de IM', 'data-home': 'Trocar diretório de configuração…', restart: 'Reinício rápido',
