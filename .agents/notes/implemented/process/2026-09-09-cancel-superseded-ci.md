...
This reverses the cancellation exemption in the [failover runbook](2026-07-26-ci-failover-runbook.md) and [master-only platform CI](2026-09-06-master-only-platform-ci.md). Those notes retain independent value for pool trust, switching, and platform coverage. The [release rehearsal decision](2026-09-06-release-rehearsal-selfhosted.md) retains runner selection and isolation ownership. None is fully superseded or archived.
