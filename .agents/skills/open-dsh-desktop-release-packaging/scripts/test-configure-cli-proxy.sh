...
for shell in bash zsh; do
  ...
  [[ "$proxy_output" == 'http://127.0.0.1:7890|http://127.0.0.1:7890|socks5h://127.0.0.1:7890|localhost,127.0.0.1,::1' ]]
  ...
  explicit_output=$(env -u HTTP_PROXY -u ALL_PROXY -u http_proxy -u https_proxy -u all_proxy \
    ...
    fixture "$script_directory/configure-cli-proxy.sh")
  [[ "$explicit_output" == '|http://explicit.invalid:8080|http://explicit.invalid:8080' ]]
