...
| `event:external-tools/resolved` | event | `68bec9ab0213191ac3b19deb41231bd973fb444a25e2085f922fe4277f9a20e5` | [`event:external-tools/resolved`](#persistence-type-eventexternal-toolsresolved) |
...
Source: [`packages/preset/agent-presets/src/session.ts:42`](../packages/preset/agent-presets/src/session.ts)
...
Source: [`packages/preset/agent-presets/src/session.ts:48`](../packages/preset/agent-presets/src/session.ts)
...
Sources: [`packages/preset/agent-presets/src/session.ts:42`](../packages/preset/agent-presets/src/session.ts)
...
### `event:external-tools/resolved`

SHA-256: `68bec9ab0213191ac3b19deb41231bd973fb444a25e2085f922fe4277f9a20e5`

| Property | Presence | Type |
|---|---|---|
| `data` | required | [`event:external-tools/resolved.data`](#persistence-type-eventexternal-toolsresolveddata) |
| `ignorable` | optional | `true` |
| `seq` | required | `number` |
| `time` | required | `number` |
| `type` | required | `"external-tools/resolved"` |

<a id="persistence-type-eventexternal-toolsresolveddata"></a>

### `event:external-tools/resolved.data`

SHA-256: `bd7d37ddd92bc17b7b7f61eca8c5d54ed59f43e29287bbc449ab857ddcc9d351`

Sources: [`packages/preset/agent-presets/src/session.ts:48`](../packages/preset/agent-presets/src/session.ts)

| Property | Presence | Type |
|---|---|---|
| `step` | required | `number` |
| `tools` | required | [`event:external-tools/resolved.data.tools`](#persistence-type-eventexternal-toolsresolveddatatools) |
| `turn` | required | `number` |

<a id="persistence-type-eventexternal-toolsresolveddatatools"></a>

### `event:external-tools/resolved.data.tools`

SHA-256: `7c6909e92a2d720b6d5679641acf2c2cfdf02df82554d8db23cbfccb0eb58145`

Array of [`event:external-tools/resolved.data.tools[0]`](#persistence-type-eventexternal-toolsresolveddatatools0).

<a id="persistence-type-eventexternal-toolsresolveddatatools0"></a>

### `event:external-tools/resolved.data.tools[0]`
...
| Property | Presence | Type |
|---|---|---|
| `dialect` | required | [`event:external-tools/resolved.data.tools[0]`](#persistence-type-eventexternal-toolsresolveddatatools0) |
...
<a id="persistence-type-external-toolsresolved"></a>
