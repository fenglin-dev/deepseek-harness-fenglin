...
来源：[`packages/preset/agent-presets/src/session.ts:42`](../packages/preset/agent-presets/src/session.ts)
...
来源：[`packages/preset/agent-presets/src/session.ts:48`](../packages/preset/agent-presets/src/session.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`event:external-tools/resolved.data`](#persistence-type-eventexternal-toolsresolveddata) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
|---|---|---|
| `step` | 必需 | `number` |
| `tools` | 必需 | [`event:external-tools/resolved.data.tools`](#persistence-type-eventexternal-toolsresolveddatatools) |
| `turn` | 必需 | `number` |
...
[`event:external-tools/resolved.data.tools[0]`](#persistence-type-eventexternal-toolsresolveddatatools0) 的数组。
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `dialect` | 必需 | [`event:external-tools/resolved.data.tools[0]`](#persistence-type-eventexternal-toolsresolveddatatools0) |
| `handlerId` | 必需 | `string` |
| `matcher` | 可选 | `string` |
| `point` | 必需 | `string` |
| `turn` | 必需 | `number` |
