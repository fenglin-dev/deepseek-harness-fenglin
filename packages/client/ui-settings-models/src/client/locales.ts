...
export const en = {
  ...
  'setup.title': "Set up DeepSeek Harness",
  'setup.description': "Connect your accounts to get started.",
  ...
  'setup.progress': "{current} of {total}",
  'setup.completed': "Setup complete",
  'setup.saveError': "Could not save settings.",
  'setup.language': "Language",
  'setup.models.title': "Models",
  'setup.models.description': "Add an API key for the models you want to use.",
  'setup.phone.title': "Phone",
  'setup.phone.description': "Optional phone sign-in.",
  'setup.im.title': "Messages",
  'setup.im.description': "Optional messaging integration.",
  'setup.codex.title': "Codex",
  'setup.codex.description': "Optional Codex tools.",
  'setup.step.models': "Models",
  'setup.step.phone': "Phone",
  'setup.step.messages': "Messages",
  'setup.step.codex': "Codex",
  'setup.step.ready': "Ready",
  'setup.success': "Success",
  'setup.ready': "Ready",
  'setup.successDescription': "You are all set.",
  'setup.readyDescription': "Everything is ready to go.",
  'setup.starting': "Starting…",
  'setup.experience': "Choose your experience",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  'setup.title': "设置 DeepSeek Harness",
  'setup.description': "连接你的账号以开始使用。",
  'setup.start': "开始设置",
  'setup.skip': "跳过",
  'setup.skipAll': "全部跳过",
  'setup.skipped': "已跳过",
  ...
  'setup.connect': "连接",
  'setup.optional': "可选",
  'setup.progress': "第 {current} / {total} 步",
  'setup.completed': "设置完成",
  'setup.saveError': "无法保存设置。",
  'setup.language': "语言",
  'setup.models.title': "模型",
  'setup.models.description': "为需要使用的模型添加 API 密钥。",
  'setup.phone.title': "手机",
  'setup.phone.description': "可选手机登录。",
  'setup.im.title': "消息",
  'setup.im.description': "可选消息集成。",
  'setup.codex.title': "Codex",
  'setup.codex.description': "可选 Codex 工具。",
  'setup.step.models': "模型",
  'setup.step.phone': "手机",
  'setup.step.messages': "消息",
  'setup.step.codex': "Codex",
  'setup.step.ready': "就绪",
  'setup.success': "成功",
  'setup.ready': "就绪",
  'setup.successDescription': "全部就绪。",
  'setup.readyDescription': "一切准备就绪。",
  'setup.starting': "启动中…",
  'setup.experience': "选择体验",
  'composerHint': "输入消息…",
